"""
Django settings for book_review_web project.
...
SECRET_KEY = "django-insecure-bxg873(g@bb61362i%**1035f^ny$j233gua1i^wh56kd%@1qy"
...
ROOT_URLCONF = "book_review_web.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.common.context_processors.navbar_links",
            ],
        },
    },
]

WSGI_APPLICATION = "book_review_web.wsgi.application"
...
if USE_CACHE:
    CACHES = {
        'default': {
            # Use django-redis backend instead of Django's native RedisCache
